...
@section('container')
    <section>
        <div class= "container px-4 px-lg-5 text-center">
            ...
            <div class="row gx-5 justify-content-between align-items-center pt-5">
                <p class="text-center mb-5 fs-2 fw-bold"> LAYANAN KAMI </p>
                ...
                <div class="col-lg-4 order-lg-0">
                    ...
                    <div class="features-device-mockup">
                        ...
                        <img src="/img/baju.png" style = "width : 400px ; height: 530px">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                <div class="col-12 col-lg-5">
                    <h2 class="display-4 lh-1 mb-4">MENGAPA HARUS EXPRESS LAUNDRY?</h2>
                ...
                <div class="col-sm-8 col-md-6">
                    <div class="px-5 px-sm-0">
                        <img src="/img/selimut.png" alt="..." style = "width :500px ; height:550px"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-gradient-primary-to-secondary" id="download">
        <div class="container px-5">
            <h2 class="text-center text-black font-alt mb-4">Nikmati Layanan Express Laundry!</h2>
